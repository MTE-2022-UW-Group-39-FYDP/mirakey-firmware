 ...
 */
void render8x8(const unsigned char *bitmap) {
    int set;
...
void render72x40(const unsigned char *bitmap) {
    int set;
...
uint32_t* upscale8to32(const unsigned char *bitmap) {
 ...
 */
unsigned char* center32x32in72x40(const uint32_t *bitmap) {
    static unsigned char result[360];
    memset(result, 0, sizeof(result));
