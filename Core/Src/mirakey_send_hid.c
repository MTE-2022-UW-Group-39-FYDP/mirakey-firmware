...
const char ascii_to_hid_key_map[165][2] = {
	...
	{0,0}, // DEL TODO: fill in
	{0,0}, //Layer toggle
	{0, KEY_LEFT},{0, KEY_UP},{0, KEY_RIGHT},{0, KEY_DOWN},
	{0, KEY_SYSRQ},{0, KEY_HOME},{0, KEY_PAGEUP},{0, KEY_PAGEDOWN},{0, KEY_END},
	{0, KEY_P},{0, KEY_P},{0, KEY_PAGEDOWN},{0, KEY_PAGEUP},{0, KEY_0},{0, KEY_9},
	{KEY_MOD_LCTRL, KEY_S},{KEY_MOD_LCTRL, KEY_P},{KEY_MOD_LCTRL, KEY_F},{KEY_MOD_LCTRL, KEY_Z},{KEY_MOD_LCTRL, KEY_Y},
	{KEY_MOD_LCTRL, KEY_X},{KEY_MOD_LCTRL, KEY_C},{KEY_MOD_LCTRL, KEY_V},{KEY_MOD_LCTRL, KEY_N},
	{0, KEY_A},{0, KEY_B},{0, KEY_C},{0, KEY_D},{0, KEY_E},{0, KEY_F},{0, KEY_G},{0, KEY_H},{0, KEY_I},{0, KEY_J},{0, KEY_K},{0, KEY_L},{0,KEY_7},{0,KEY_8}
};
