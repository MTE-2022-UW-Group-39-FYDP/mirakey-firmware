...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, MKS_CS11_Pin|LED_Pin|MKS_CS5_Pin|MKS_CS8_Pin
                          |MKS_CS2_Pin|MKS_CS3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MKS_CS0_Pin|MKS_CS1_Pin|MKS_CS4_Pin|MKS_CS7_Pin
                          |MKS_CS10_Pin|MKS_DC_Pin|MKS_RES_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MKS_CS9_GPIO_Port, MKS_CS9_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MKS_CS6_GPIO_Port, MKS_CS6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : MKS_CS11_Pin LED_Pin MKS_CS5_Pin MKS_CS8_Pin
                           MKS_CS2_Pin MKS_CS3_Pin */
  GPIO_InitStruct.Pin = MKS_CS11_Pin|LED_Pin|MKS_CS5_Pin|MKS_CS8_Pin
                          |MKS_CS2_Pin|MKS_CS3_Pin;
  ...
  /*Configure GPIO pins : MKS_CS0_Pin MKS_CS1_Pin MKS_CS4_Pin MKS_CS7_Pin
                           MKS_CS10_Pin MKS_DC_Pin MKS_RES_Pin */
  GPIO_InitStruct.Pin = MKS_CS0_Pin|MKS_CS1_Pin|MKS_CS4_Pin|MKS_CS7_Pin
                          |MKS_CS10_Pin|MKS_DC_Pin|MKS_RES_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : MKS_CS9_Pin */
  GPIO_InitStruct.Pin = MKS_CS9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MKS_CS9_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : MKS_CS6_Pin */
  GPIO_InitStruct.Pin = MKS_CS6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MKS_CS6_GPIO_Port, &GPIO_InitStruct);
